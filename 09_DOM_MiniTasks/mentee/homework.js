...
newLi.textContent = "TrollHunters";
newLi.classList.add("movie-item");
moviesList.appendChild(newLi); 

const newLi1 = document.createElement("li");
newLi1.textContent = "Fairy Tail";
newLi1.classList.add("movie-item");
moviesList.appendChild(newLi1);

// const removeLi = moviesList.querySelector("li");
// if(removeLi) {
//     removeLi.remove()
// }

const removeLi2 = moviesList.querySelectorAll("li");
if (removeLi2[2]){
    removeLi2[2].remove()
};

const newMovieCount = moviesList.children.length;
moviesInfo.textContent = `You currently have ${newMovieCount} favorite movies in your list.`;